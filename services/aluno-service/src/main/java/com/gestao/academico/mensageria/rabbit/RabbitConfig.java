...
public class RabbitConfig {
    ...
    // Não é necessário queue no aluno-service para publicar;
    // mas mantemos as routing keys comuns para padronizar.
    ...
    public Declarables declarables() {
        ...
        // Declarar queues também evita race condition quando o listener sobe depois.
